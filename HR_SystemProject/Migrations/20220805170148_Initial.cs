    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    date = table.Column<DateTime>(type: "date", nullable: false, defaultValue: new DateTime(2022, 8, 5, 0, 0, 0, 0, DateTimeKind.Unspecified)),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Attendence", x => new { x.Emp_Id, x.date });
                    table.ForeignKey(
                        name: "FK_Attendence_Employee_Emp_Id",
                        column: x => x.Emp_Id,
